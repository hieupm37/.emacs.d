...
(my/external-package 'tree-sitter
  ...
  (setq my/tree-sitter-class-like '((c++-mode . (class_definition))))
  (setq my/tree-sitter-function-like '((c++-mode . (function_definition))))
  ...
  ;; mode-line-idle requires emacs-20.1
  ;; (my/external-package 'mode-line-idle
  ;;   (setq-default header-line-format
  ;;                 (list
  ;;                  '(:eval (mode-line-idle 0.3
  ;;                                          '(:propertize (:eval
  ;;                                                         (if (boundp 'tree-sitter-mode)
  ;;                                                             (let ((thing-name (my/tree-sitter-thing-name 'class-like)))
  ...
  ;;                                          '(:propertize (:eval
  ;;                                                         (if (boundp 'tree-sitter-mode)
  ;;                                                             (let ((thing-name (my/tree-sitter-thing-name 'function-like)))
  ;;                                                               (if thing-name (format ":%s" thing-name)))))
  ;;                                                        face
  ;;                                                        hima-simple-gray)
  ;;                                          ""))
